...
describe('FilialeFeatureStyle', () => {
    ...
    const testee = new FilialeFeatureStyle('FFFFFF', '2695E4');
    ...
    describe('style function', () => {
        ...
        test('should create style function for 250 resolution', () => {
            ...
            expect(testee.getStyleFunction()(feature, 250).getText().getFill().getColor()).toBe('#2695E4');
